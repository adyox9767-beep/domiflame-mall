      ...
      <section className="px-5 py-10 lg:px-16">
        <div className="mx-auto grid max-w-[1300px] gap-8 lg:grid-cols-[560px_1fr]">
          <div className="rounded-[32px] bg-white p-6 shadow-lg">
            <div className="grid h-[520px] place-items-center rounded-[24px] bg-[#f1f1f1]">
              <span className="text-xl font-black text-[#aaa]">Product Image Soon</span>
            </div>
          </div>
          ...
          <div className="rounded-[32px] bg-white p-8 shadow-lg">
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              <button className="flex flex-1 items-center justify-center gap-3 rounded-2xl bg-[#ffb300] py-4 text-lg font-black transition hover:bg-[#111] hover:text-white">
